...
#WSSERVERURL
wsServerUrl = cfg.get("DEFAULT", "WSSERVERURL")
print(f"wsServerUrl: {wsServerUrl}", flush=True)
    ...
    "sessions": [
        {
            ...
            "websocket": {
                "mode": 'external',
                "externalUrl": wsServerUrl,
                "useSTOMP": 'false',
                "minimumDelay": 0
            },
            "content": {
                "incremental": ['metadata','segments'],
                "full": []
            },
            "metadata" : [
                { "name": "LEFT_CHANNEL_NAME", "value": "CH1" },
                { "name": "CALLER1", "value": "CH1" },
            ]
        },
        {
            "asyncMode": "REAL-TIME",
            ...
            "metadata" : [
                { "name": "RIGHT_CHANNEL_NAME", "value": "CH2" },
                { "name": "CALLER2", "value": "CH2" },
            ]
        },
...
def process_ws_msg(wsMsg):
  ...
  try:
    ...
    if ssId == "right":
      #'\033[92m'
      print("\033["+bold+"92m\n\t"+formatted_time_difference +' '+ssId+" \t"+ out + '\033[0m', flush=True)
    else:
      print("\033["+bold+"94m\n\t"+formatted_time_difference +' '+ssId+" \t"+ out + '\033[0m', flush=True)
