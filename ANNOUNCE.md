...
* #rcj-393: New sessions takes few extra msec to start after a loger pause between request 
* #rcj-379: customer reports that Expired transcripts are still visible (Edge deplyment)
