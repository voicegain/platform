...
search_url = "https://transcribe.ascalon.ai/ascalon-web-api/asr/meeting/search/fields"

#search_query = ""
search_query = "field=AUDIO_SRC"

# computer the authrization header without which the request will fail
mac = computeMAC(search_query, api, auth_token, nonces.pop())
print("mac: " + mac)
