    ...
    if(event.get("Records") is not None):
        ...
        try:
            ...
            for record in records:
                ...
                audioDataResponse = http.urlopen("POST", dataAudioUrl, headers=headers, body=json.dumps(audioRequest)).data.decode("utf-8")
                objectId = str(json.loads(audioDataResponse).get("objectId"))
                ...
                print(str(asr_response_raw.data.decode("utf8")))
