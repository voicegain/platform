        ...
        "asr": {
            "grammars" : [

                {
                    ...
                    "grammar": "spanish-numbers",
                    "public": {
                        "root" : "<cero>{0}|<uno>{1}|<dos>{2}|<tres>{3}|<cuatro>{4}|<cinco>{5}|<seis>{6}|<siete>{7}|<ocho>{8}|<nueve>{9}|<diez>{10}|<sí>{Y}|<no>{N}"
                    },
                    "rules": {
                        "cero" : "cero|zero",
                        "uno" : "uno",
...
if not os.path.exists("output"):
    os.mkdir("output")
output_path = "output{}".format("/spanish-grammar")
