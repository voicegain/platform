...
sa_session_body = {
    ...
    'tags': ['testing'],
    'ptimizeForWebUi': 'level2', # Set to level2 to support Voicegain Speech Analytics App. If you do not need the additional fields then set to none to save resources and speed up processing.
    'audio': [{
        'source': {
